...
- **Build and installation infrastructure**:
  - Optimized JSON string formatters for improved performance.
  - Updated UDF signatures for better compatibility and clarity.
  - Ensured `install.sql` is up-to-date with the latest changes.
