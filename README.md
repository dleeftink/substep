...
Above all: it just makes sense. We can globally call `substep.get.parsed(obj)` when we want to get a parsed SQL object (struct) in a substep of an existing workflow.
